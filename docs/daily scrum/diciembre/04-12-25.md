...
- [x] Admin ve estadísticas reales (usuarios por rol, sesiones, documentos).
- [x] Gráfica de actividad muestra datos de los últimos 7 días.
- [x] Professor puede matricular estudiantes en SUS asignaturas.
- [x] Admin puede asignar asignaturas a profesores.
- [x] Admin puede promover estudiante a profesor o profesor a admin.
