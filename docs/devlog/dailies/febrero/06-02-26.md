...
- [x] ARI and NMI calculados para ambos algoritmos.
- [x] Coeficiente de partición FCM documentado.
- [x] Lista de FAQs generada (centroides).
- [x] Tabla comparativa K-Means vs FCM documentada.
