...
import pytest
from rag_service.documents.document_processor import DocumentProcessor, get_document_processor
...
def test_chunk_documents_multiple():
    ...
    docs = [
        ...
        Document(content="This is a much longer document that will be chunked." * 3, 
                metadata=make_metadata(), doc_id="doc2"),
...
def test_custom_separators():
    ...
    separators = ["\n\n", "\n", ". "]
    processor = DocumentProcessor(chunk_size=50, chunk_overlap=10, separators=separators)
